...
describe('JSON Reporter', () => {
  ...
  test('should generate correct summary', () => {
    const report = generateJsonReport(mockInventory, mockExecution);
  ...
  test('should list unused functions', () => {
    const report = generateJsonReport(mockInventory, mockExecution);
  ...
  test('should list executed functions with counts', () => {
    const report = generateJsonReport(mockInventory, mockExecution);
  ...
  test('should handle zero coverage', () => {
    ...
    const report = generateJsonReport(mockInventory, emptyExecution);
